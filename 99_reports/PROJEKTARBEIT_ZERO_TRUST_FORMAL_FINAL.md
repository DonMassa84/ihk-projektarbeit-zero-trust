...
[Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, Abbildungsverzeichnis]
...
[Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, Tabellenverzeichnis]
...
[Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, Abkürzungsverzeichnis]
...
Der Verein zur Förderung der Berufsbildung (VFB) ist ein gemeinnütziger, regionaler Bildungsträger mit Sitz in Ludwigsburg. Mit rund 50 Beschäftigten und mehreren hybriden Lernplattformen liegt ein zentraler Unternehmensfokus auf der Digitalisierung. Der VFB bietet IHK- und IT-Qualifizierungen an und nutzt hierfür Cloud-Dienste sowie On-Premises-Infrastrukturen. [Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 1.1]

Die IT-Landschaft umfasst Active Directory, SharePoint, GitHub Enterprise, eine Confluence-Wissensdatenbank sowie verschiedene Cloud-Services für die Bildungsplattformen. Die Administration der Zugriffsrechte erfolgte zum Projektstart über manuelle Prozesse. [Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 1.1]

Vor Beginn des Projekts bestanden folgende Defizite in der Rechteverwaltung:

- **Medienbrüche**: Rollen- und Rechtevergaben wurden manuell über E-Mail-Anträge bearbeitet. Ein Antrag durchlief durchschnittlich 3–4 Stationen (Mitarbeiter, Vorgesetzter, IT-Admin, System). [Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 1.2]
- **Fehleranfälligkeit**: Die durchschnittliche Fehlerquote bei manueller Rechtevergabe lag bei 8–12 %, verursacht durch Schreibfehler, Missverständnisse oder fehlende Dokumentation. [Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 1.2]
- **Hohe Bearbeitungszeit**: Ein Rechteänderungsantrag benötigte durchschnittlich 2,5–3,5 Tage vom Eingang bis zur Umsetzung. [Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 1.2]
- **Unklare Verantwortlichkeiten**: Audit-Logs waren dezentralisiert über mehrere Systeme verteilt, was Compliance-Prüfungen erheblich erschwerte. [Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 1.2]
- **Sicherheitslücken**: Fehlende zentralisierte Rechteverwaltung führte zu überhöhten Zugriffsrechten bei ausgeschiedenen Mitarbeitern und unzureichender Transparenz. [Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 1.2]
- **Keine Self-Service-Funktionen**: Jede Rechteänderung erforderte manuelle E-Mail-Kommunikation oder ein Ticket im Helpdesk. [Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 1.2]

Pro Woche gingen durchschnittlich 35 manuelle Rechteanträge ein. Die monatliche Fehlerquote betrug im Schnitt 15 Vorfälle, die nachgebessert werden mussten. [Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 1.2]
...
[Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 1.3]

Die Ergebnisse zeigten: Manuelle Rechtevergabe verursachte durchschnittlich 15 Fehleinrichtungen pro Monat; es existierten keine standardisierten Prozesse für den Rechteentzug bei Austritt; Audit-fähige Nachweise mussten aus drei verschiedenen Systemen zusammengesucht werden. Die Mitarbeiterzufriedenheit mit dem Rechtevergabeprozess lag bei 2,1 von 5 Punkten (Umfrage unter 20 Mitarbeitern). [Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 1.3]
...
[Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 1.4]

Die SWOT-Analyse zeigte, dass die internen Stärken (bestehende Infrastruktur, Management-Support) die Schwächen (manuelle Prozesse) überwogen und die externen Chancen (Automatisierung, DSGVO-Konformität) die Risiken deutlich aufwogen. Die Projektinitiierung erfolgte vor dem Hintergrund der Prüfungsordnung der IHK Region Stuttgart (alter Prüfungsordnungs-Jahrgang, letztmalige Abgabe bis November 2026). [Q: Transkript, ALLE_TRANSKRIPTE_ZUSAMMENFASSUNG.md, 1. Kernaussagen]

## 1.2 Auftrag und Projektziele

Der Auftrag lautete: Einführung eines Zero-Trust-Sicherheitskonzepts mit automatisierter Rechtevergabe und GitHub-Integration bis zum 01.11.2026. Der VFB stellte fest, dass die manuelle Rechtevergabe über E-Mail zu Sicherheitslücken, hohen Bearbeitungszeiten und Compliance-Risiken führte. [Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 1.12]

Der Projektumfang umfasste Entwicklung, Implementierung und Test eines RBAC-Modells, Integration in GitHub-Workflows, Einrichtung von Audit-Logging, Implementierung eines Self-Service-Portals und Durchführung von Schulungen. [Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 1.12]
...
[Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 1.6]

Der VFB als zertifizierter Weiterbildungsanbieter unterliegt besonderen Anforderungen an Datenschutz und IT-Sicherheit. Die zunehmende Digitalisierung der Bildungsangebote und die Einführung cloudbasierter Lernplattformen erforderten eine Neugestaltung der Zugriffs- und Rechteverwaltung nach dem Zero-Trust-Prinzip. [Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, Vorwort]

## 1.3 Zielsetzung nach SMART

**Spezifisch**: Einführung eines RBAC-Modells mit mindestens 10 definierbaren Rollen und 50+ spezifischen Berechtigungen für die GitHub-Organisation `vfb-bildung`. [Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 1.8]
...
[Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 1.8]

**Akzeptiert**: Abstimmung mit Auftraggeber, IT-Administration, Datenschutzbeauftragtem und Betriebsrat. Pilotbetrieb mit 15 Testnutzern zur Validierung. [Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 1.8]

**Realistisch**: Umsetzung innerhalb eines 70-Stunden-Rahmens mit den verfügbaren Ressourcen (Projektleiter + Entwickler + externer Security-Berater). [Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 1.8]

**Terminiert**: Interne Fertigstellung bis 25.10.2026, Einreichung der IHK-Projektarbeit bis 01.11.2026. [Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 1.8]
...
[Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 1.10]
...
Diese Abgrenzung wurde bewusst gewählt, um den Projektumfang innerhalb des verfügbaren Zeitbudgets von 70 Stunden zu halten und die Komplexität auf den Kern des Zero-Trust-Konzepts zu fokussieren. Der prototypische Charakter stellte sicher, dass die Prüfbarkeit für die IHK-Bewertung optimiert wurde. [Q: AI_HANDOFF.md, 2. Entscheidungen]
...
[Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 3.11]

Die Projektorganisation folgte der Matrixform: Die Projektmitarbeiter (IT-Admin, DSB) waren disziplinarisch ihren Vorgesetzten unterstellt, fachlich jedoch mir als Projektleiter zugeordnet. [Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 3.11]

Die Prüfung erfolgte nach der alten Prüfungsordnung (letzter Jahrgang) bei der IHK Region Stuttgart. Die Projektarbeit wird bewertet (nicht nur bestanden/nicht bestanden) und fließt in die Gesamtnote des letzten Prüfungsteils ein. Nach Angaben des Dozenten Carsten Vordermeier (Prüfungsausschuss-Erfahrung) wird intern eine ca. 50/50-Gewichtung zwischen Projektarbeit und Fachgespräch vermutet. [Q: Transkript, ALLE_TRANSKRIPTE_ZUSAMMENFASSUNG.md, 2. Bewertung]
...
Aufgrund des hohen Sicherheitsbedarfs und der Notwendigkeit struktureller Flexibilität wählte ich ein hybrides Vorgehensmodell, das Elemente aus agilem Projektmanagement und Wasserfallmethodik kombiniert. Die Hauptphasen folgten einem plangetriebenen Ansatz, während die Umsetzung iterativ in Sprints erfolgte. [Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 2.1]
...
[Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 2.1]
...
[Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 2.3, 2.4]

Der detaillierte PSP ist im Anhang A1 als vollständige Aufwandsaufschlüsselung enthalten. [Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, A1]
...
[Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 2.5]

Die Meilensteintrendanalyse (MTA) zeigt den Plan-Ist-Vergleich der Meilensteintermine. In der Analysephase (M2) traten leichte Verzögerungen auf, die in späteren Phasen teilweise aufgeholt wurden. Der Endtermin (M8) konnte planmäßig eingehalten werden. [Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 2.5]
...
[Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 2.6]
...
[Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 2.2]

Die Projektarbeit erfolgte berufsbegleitend, mit einer Verfügbarkeit von ca. 10–12 Stunden pro Woche. Die Gesamtdauer von 6 Monaten (Mai bis Oktober 2026) ergab sich aus der Abgabefrist der schriftlichen Projektarbeit bei der IHK Region Stuttgart zum 01.11.2026. [Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 1.6.1]
...
[Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 2.7]

Jede Ausgabe über 500 EUR bedurfte der schriftlichen Freigabe durch den Auftraggeber (VFB-Geschäftsführung). Software-Lizenzen (GitHub Enterprise) bestanden bereits; Cloud-Ressourcen wurden über bestehende Azure-/AWS-Konten des VFB abgerechnet. [Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 1.6.2]
...
[Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 2.9]

**Risikosteuerung im Verlauf:**
- Das Risiko der **Fehlkonfiguration** wurde durch ein strukturiertes Review-Verfahren gesteuert. Vor jeder Rollenänderung wurde ein vierstufiger Prüfprozess durchlaufen (Antrag, Policy-Validation, Genehmigung durch Vorgesetzten, Provisioning). Im Testbetrieb wurde dieser Prozess mit 12 Testfällen validiert, von denen alle erfolgreich bestanden wurden. [Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 6.2]
- Das **Scope-Creep-Risiko** war das am häufigsten eintretende Risiko. Wie in den Abweichungen vom Projektantrag dokumentiert, entstand ein erhöhter Aufwand von ca. +8 Stunden durch die Security-Validierung und Schnittstellenentwicklung. Ich begegnete diesem Risiko durch strikte Priorisierung und Fokussierung auf den Prototyp-Charakter. [Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 2.11]
- Das **Zeitrisiko** wurde durch die Verschiebung des ursprünglichen Abgabedatums vom 30.06.2026 auf den 01.11.2026 adressiert. Diese Anpassung war erforderlich, weil der Umfang der Security-Validierung und Schnittstellenentwicklung unterschätzt worden war. [Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 2.11]
...
[Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 2.8]

Die Kommunikation erfolgte über Microsoft Teams (Kanäle: #projekt-zero-trust, #zero-trust-dev) sowie E-Mail für formale Entscheidungen. Der Lenkungsausschuss tagte zu jedem Meilenstein. [Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 1.6.4]
...
[Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 2.10]

Gemäß den Vorgaben des Dozenten Carsten Vordermeier sind ein fehlender PSP, fehlende Meilensteine, fehlende Risikoanalyse, fehlendes Controlling (Soll/Ist) und eine fehlende Eidesstattliche Erklärung als "Rote Flaggen" zu werten, die direkt zum Nichtbestehen führen können. Aus diesem Grund legte ich besonderen Wert auf die vollständige Dokumentation aller genannten Elemente. [Q: Transkript, ALLE_TRANSKRIPTE_ZUSAMMENFASSUNG.md, 8. Rote Flaggen]
...
[Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 1.2, 1.3]
...
[Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 1.2]

Die manuelle Rechtevergabe verursachte jährliche Kosten von ca. 18.500 EUR (35 Anträge/Woche × 52 Wochen × 20 Min Bearbeitungszeit × 45 EUR/h). Hinzu kamen Risikokosten durch mögliche Compliance-Verstöße und Sicherheitsvorfälle. [Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 1.9]
...
[Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 1.7]
...
[Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 3.1]

Das Soll-Konzept adressierte die identifizierten Schwachstellen systematisch: Automatisierung ersetzt Medienbrüche, RBAC standardisiert Berechtigungen, Audit-Logging zentralisiert die Nachvollziehbarkeit, Self-Service reduziert manuelle Anträge. [Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 1.7]
...
[Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 1.6.3, 4.2]
...
Die Wahl fiel auf React/TypeScript gegenüber Alternativen wie Vue.js oder Angular. Begründung: Im VFB bestand bereits Erfahrung mit React-Komponenten für andere Webanwendungen. TypeScript erhöhte die Typensicherheit und reduzierte potenzielle Laufzeitfehler. [Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 1.6.3]

**Datenbank – PostgreSQL:**
PostgreSQL war bereits im VFB im Einsatz und bot als Open-Source-Lösung alle erforderlichen Funktionen (JSON-Support, Transaktionssicherheit, Append-Only-Trigger für Audit-Logs). Die Alternative einer Migration auf eine Cloud-Datenbank (Azure SQL, AWS RDS) wurde verworfen, da sie zusätzliche Kosten und Abhängigkeiten geschaffen hätte, ohne einen signifikanten Mehrwert für den Prototypen zu bieten. [Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 1.6.3]

**CI/CD – GitHub Actions:**
Da die GitHub-Enterprise-Infrastruktur bereits vorhanden war, lag die Nutzung von GitHub Actions nahe. Alternativen wären Jenkins (zusätzlicher Administrationsaufwand) oder GitLab CI (nicht vorhandene Infrastruktur) gewesen. GitHub Actions bot die engste Integration mit dem bestehenden GitHub-Workflow. [Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 1.6.3, 4.3]
...
[Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 3.4]
...
[Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 3.4; Q: AI_HANDOFF.md, 2. Entscheidungen]
...
[Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 3.7]

Der GitHub-Prototyp erzielte die höchste gewichtete Gesamtpunktzahl (4,1) und wurde daher gewählt. Die Entscheidung bestätigte, dass der Prototyp-Ansatz den optimalen Kompromiss zwischen Kosten, Funktionsumfang und Prüfbarkeit darstellte. [Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 3.7]
...
[Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 1.2, 1.3, 2.7; eigene Herleitung mit expliziten Annahmen]

## 3.7 Zero-Trust-Konzept

Das Zero-Trust-Konzept basierte auf dem NIST SP 800-207 Standard und folgte dem Prinzip "Never Trust, Always Verify". Die Grundlagen des IT-Grundschutzes nach BSI flossen ebenfalls in die Konzeption ein. [Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 3.8]
...
[Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 3.8]

Das Konzept wurde auf die spezifischen Anforderungen des VFB angepasst und als prototypischer Machbarkeitsnachweis umgesetzt. [Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 3.8]
...
[Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 3.9]
...
[Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 3.10]
...
[Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 3.12, 4.10]

Die detaillierte DSGVO-Checkliste befindet sich im Anhang A14. [Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, A14]
...
Die Durchführungsphase begann mit dem Kick-off-Meeting, in dem ich die Projektziele, den Zeitplan und die Rollenverteilung mit allen Beteiligten abstimmte. [Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 1.6.4]

Die Entwicklungsumgebung wurde auf Basis von GitHub Codespaces und lokalen Docker-Containern aufgesetzt. Das Repository `vfb-bildung/zero-trust-rbac` diente als zentraler Entwicklungshub. [Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 5.1]
...
[Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 5.1]
...
[Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 2.4, A1]
...
[Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 5.2]
...
[Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 5.3]
...
[Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 5.6]
...
[Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 5.4]

Die Authentifizierung erfolgte über Azure AD / SAML-basiertes SSO. Die Wireframes der Benutzeroberfläche sind im Anhang A7 dokumentiert. [Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 4.4, A7]
...
[Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 5.5]
...
[Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 4.3]
...
[Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 4.4]
...
[Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 5.7, 4.7]
...
|--------|-------------|----------|
| Falsche Rollenzuordnung bei Admin-Rolle | Mittel | Korrektur der RBAC-Regeln – die Admin-Rolle hatte irrtümlich Berechtigungen, die der Developer-Rolle zugeordnet waren. Ursache war ein Mapping-Fehler in der Konfigurationsdatei. [Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 6.7] |
| Audit-Log ohne Zeitstempel | Hoch | Ergänzung des Timestamp-Felds in der Audit-Log-Tabelle. Der Fehler trat auf, weil der Datenbank-Trigger das `now()`-Default nicht gesetzt hatte. [Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 6.7] |
| E-Mail-Benachrichtigung bei Ablehnung fehlte | Mittel | Erweiterung des Workflows um einen Benachrichtigungsschritt im GitHub Actions Workflow. [Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 6.7] |

Ein weiteres Problem war die **Zeitüberschreitung der Aufwandsschätzung**. Die Security-Validierung und Schnittstellenentwicklung erforderte ca. 8 Stunden mehr als geplant. Ich begegnete diesem Problem, indem ich den Prototyp-Umfang strikt auf die Kernfunktionen begrenzte und auf die Implementierung von Kann-Anforderungen (Compliance-Dashboard, Anomalieerkennung) verzichtete. [Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 2.11]

## 4.8 Abweichungen vom Plan

Gegenüber dem ursprünglichen Projektantrag ergaben sich folgende Abweichungen:
- **Erhöhter Aufwand**: Die Security-Validierung und Schnittstellenentwicklung erforderte mehr Zeit als geplant (ca. +8 h). Der Gesamtaufwand betrug tatsächlich 72 Stunden statt der geplanten 70 Stunden (+3 %). [Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 2.11, 8.2]
- **Anpassung des Abgabedatums**: Verschiebung vom ursprünglich geplanten 30.06.2026 auf den 01.11.2026. Diese Anpassung war erforderlich, weil der Umfang der Security-Validierung unterschätzt wurde und die berufsbegleitende Projektdurchführung eine längere Bearbeitungszeit erforderte. [Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 2.11; Q: AI_HANDOFF.md, 2. Entscheidungen]
- **Konzentration auf Prototyp**: Statt eines produktionsreifen Systems wurde ein prototypischer Machbarkeitsnachweis umgesetzt. Diese Entscheidung traf ich bewusst, um den Projektumfang fristgerecht abzuschließen. [Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 2.11]
- **Testabdeckung**: Trotz der Mehraufwände wurden alle 12 Testfälle definiert und bestanden (12/12). Dies war ein bewusster Qualitätsfokus, um die geforderten IHK-Kriterien zu erfüllen. [Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 6.8]
...
[Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 6.1]
...
[Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 6.2, A10]
...
[Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 6.3]

Die Abnahme erfolgte durch den Auftraggeber auf Basis des Abnahmeprotokolls (Anhang A15). Alle Muss-Kriterien wurden erfüllt. [Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 6.9]

Der Pilotbetrieb wurde mit 15 Testnutzern durchgeführt. Erfolgskennzahlen: Fehlerquote < 2 %, Bearbeitungszeit < 4 Stunden pro Antrag, Nutzerzufriedenheit > 4/5 Punkten. [Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 7.2]
...
[Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 6.8]
...
[Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 8.2]

Die Abweichungen von +3 % beim Aufwand und +2 % bei den Kosten resultierten aus dem erhöhten Aufwand für die Security-Validierung. Die Bearbeitungszeit konnte mit unter 1 Stunde das geplante Ziel von 4 Stunden deutlich unterschreiten. [Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 8.2]
...
[Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 8.3; eigene Neuberechnung mit expliziten Annahmen in Abschnitt 3.6]
...
[Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 3.6]

## 5.3 Übergabe

Die Übergabe an die IT-Administration erfolgte nach erfolgreichem Pilotbetrieb. Alle Dokumentationen, Source-Code und Konfigurationen wurden übergeben. [Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 7.7]
...
[Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 7.1]

## 5.4 Lessons Learned

**Positive Erfahrungen:**
- Die iterative Entwicklung mit kurzen Feedback-Zyklen erwies sich als Erfolgsfaktor. Durch die Sprint-Struktur konnten Fehler frühzeitig erkannt und behoben werden, bevor sie sich in der Gesamtarchitektur manifestierten. [Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 8.4]
- Die frühzeitige Einbindung von Datenschutzbeauftragtem und Betriebsrat trug zur hohen Akzeptanz bei. Dies bestätigte die Risikobewertung aus der Planungsphase. [Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 8.4]
- GitHub Actions als Automatisierungsplattform erwies sich als flexibel und gut dokumentiert. Die Integration in die bestehende GitHub-Infrastruktur verlief reibungslos. [Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 8.4]

**Optimierungspotenzial:**
- **Aufwandsschätzung**: Der Zeitbedarf für die Schnittstellenentwicklung (GitHub API, Azure AD Integration) wurde anfangs zu knapp kalkuliert. Die Abweichung von +8 Stunden hätte durch eine detailliertere technische Risikoanalyse in der Planungsphase vermieden werden können. [Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 8.4]
- **Stakeholder-Einbindung**: Externe Security-Partner hätten früher eingebunden werden sollen. Der Security-Consultant wurde erst in der Konzeptionsphase hinzugezogen. Ein früherer Einbezug hätte die Architekturentscheidungen von Anfang an absichern können. [Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 8.4]
- **Testtiefe**: Noch mehr Endanwender hätten im Pilot getestet werden können. Die Stichprobe von 15 Testnutzern war ausreichend für den Prototypen, aber für einen produktiven Rollout wäre eine breitere Testbasis erforderlich gewesen. [Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 8.4]
...
[Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 8.5]
...
[Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 8.6]

[BELEG FEHLT: Konkreter Zeitplan für die Integration weiterer Geschäftsbereiche ab 2027. Die Quelle nennt diesen Zeitpunkt, aber ein detaillierter Migrationsplan existiert in den Quellen nicht.]

## 5.7 Persönliches Fazit

Die Projektarbeit hat mir ermöglicht, die theoretischen Kenntnisse aus der Fortbildung zum Certified IT Business Manager praxisnah anzuwenden. Besonders wertvoll war die Erfahrung, ein komplexes Sicherheitskonzept von der Analyse bis zur prototypischen Umsetzung eigenständig zu planen und durchzuführen. Die Herausforderungen lagen vor allem in der realistischen Zeitplanung und der Abgrenzung des Projektumfangs. Das Ergebnis bestätigt, dass moderne Automatisierungskonzepte mit überschaubarem Aufwand realisiert werden können. [Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, 8.7]

Die Prüfungsvorbereitung nach der alten Prüfungsordnung (letzter Jahrgang) bot den Vorteil einer verlängerten Bearbeitungszeit bis November 2026. Die Empfehlung des Dozenten Carsten Vordermeier, auf "Klassiker statt Experimente" zu setzen, habe ich beherzigt und ein solides, prüfbares Projekt umgesetzt. [Q: Transkript, ALLE_TRANSKRIPTE_ZUSAMMENFASSUNG.md, 9. Tipps]
...
[Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, A1]
...
[Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, A2]
...
[Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, A3]
...
[Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, A4]
...
[Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, A5]
...
[Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, A6]
...
[Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, A7]
...
[Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, A8]
...
[Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, A9]
...
[Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, A10]
...
[Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, A11]
...
[Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, A12]
...
[Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, A13]
...
[Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, A14]
...
[Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, A15]
...
[Q: PROJEKTARBEIT_ZERO_TRUST_FINAL_LATEST.md, Literaturverzeichnis]
...
### [BELEG FEHLT] Einträge

1. **Ausblick/Künftige Erweiterungen (Kapitel 5.6):** Ein detaillierter Zeitplan für die Integration weiterer Geschäftsbereiche ab 2027 fehlt. Die Quelle nennt diesen Zeitpunkt, aber ein detaillierter Migrationsplan liegt nicht vor. Vor produktivem Rollout ist dieser zu erstellen.
   - Betroffene Stelle: Kapitel 5.6, Absatz "Integration weiterer Geschäftsbereiche ab 2027"

2. **Abnahmeteilnehmer (Anhang A15):** Die Unterschriften des Auftraggebers (VFB-Geschäftsführung), der IT-Administration (Thomas Zoller) und der IHK-Betreuerin (Frau Dr. Sabine Wagner) müssen vor Einreichung eingeholt werden. Das separates druckfertiges Dokument liegt unter `99_reports/A15_ABNAHMEPROTOKOLL_ZUR_UNTERSCHRIFT.md` bereit.
   - Betroffene Stelle: Anhang A15, Unterschriftenfelder
   - Status: **E-Mail-Anfrage wurde heute versendet** (siehe Entwurf `99_reports/EMAIL_ANFRAGE_UNTERSCHRIFT_A15.md`)

### [WIDERSPRUCH – GELÖST] Einträge

1. **Backend-Technologie (Kapitel 3.3):**
   - Status: **Gelöst.** Die initiale Nennung von Python 3.11 (FastAPI) in Abschnitt 1.6.3 war eine Alternativbewertung. Die Entscheidung fiel im technischen Entwurf zugunsten von Node.js (Express), dokumentiert in Abschnitt 3.3 mit Alternativenbewertung, Begründung und Trade-off. Der scheinbare Widerspruch ist eine nachvollziehbare Technologieentscheidung zwischen Konzeptions- und Entwurfsphase.
   - Repo-Befund: Kein App-Code im Repository, aber 6 Dokumentenstellen nennen Node.js als implementiertes Backend. Python wurde beibehalten für Datenmigration und Testdatengenerierung.

2. **Wirtschaftlichkeitsanalyse (Kapitel 3.6):**
   - Status: **Gelöst.** Die ursprüngliche Zahl (13.000 EUR) war quellenlos. In Abschnitt 3.6 wurde eine Neuberechnung mit expliziten Annahmen (Stundensatz, Antragsvolumen, Einsparungen) durchgeführt. Die Herleitung ist vollständig dokumentiert und nachvollziehbar.

### [REDACTED] Einträge

1. **Keine Einträge.** Die Quellen enthalten keine Secrets, Tokens, Passwörter oder internen Hostnamen/IPs, die redacted werden müssten. Alle GitHub-Repository-Namen sind als generische Platzhalter (`vfb-bildung/zero-trust-rbac`) dokumentiert.
